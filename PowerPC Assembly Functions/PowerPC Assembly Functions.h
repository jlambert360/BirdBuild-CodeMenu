...
#define MENU_TEXT_YELLOW 0xFFFF44FF
#define MENU_TEXT_GRAY 0xDADADAFF
#define MENU_TEXT_MODIFIED_SELECTED 0xFFFF44ff
//#define MENU_TEXT_MODIFIED_UNSELECTED 0xEAEA8DFF
#define MENU_TEXT_MODIFIED_UNSELECTED 0x78C6E1FF
///colors end
///primitive types
