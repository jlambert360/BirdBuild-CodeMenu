...
// Set asm output path in config.cfg line 2
	...
	static string OutputAsmPath = buildPath + "Source/Project+/Tourney-CodeMenu.asm";
#elif DOLPHIN_BUILD && TOURNAMENT_BUILD
	static string OutputAsmPath = buildPath + "Source/Netplay/Tourney-Net-CodeMenu.asm";
#else
